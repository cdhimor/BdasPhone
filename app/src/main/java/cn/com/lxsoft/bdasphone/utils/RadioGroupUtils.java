...
public class RadioGroupUtils {
    ...
    public RadioGroup.OnCheckedChangeListener cancelCheckedChangeListener;
    ...
    private void setOnCheckedChangeWidgetListener(View child, boolean isRemove) {
        ...
        if (!isRemove) {
            ...
            child.setOnClickListener(new ToolbarShaiXuanClickListener());
        }
        setRBOnCheckedChangeWidgetListener(child,isRemove);

    }

    class ToolbarShaiXuanClickListener implements RadioButton.OnClickListener {

        boolean bCheckPressed=false;
        boolean bInit=false;
        @Override
        public void onClick(View view) {
            ...
            if(!bInit) {
                btn.setOnCheckedChangeListener(new DealOnChangeListener());
                bInit = true;
            }
            if(bCheckPressed==false){
                bCheckPressed=true;
            }
            else {
                //btn.setChecked(false);
                //mRG.dispatchSetSelected();
                mRG.clearCheck();
                bCheckPressed = false;
        ...
        class DealOnChangeListener implements RadioButton.OnCheckedChangeListener{
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (!isChecked)
                    bCheckPressed = false;
                //super(buttonView,isChecked);
            }
        }
    }
