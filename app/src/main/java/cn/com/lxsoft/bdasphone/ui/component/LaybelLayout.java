...
public class LaybelLayout extends ViewGroup implements View.OnClickListener {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        textBackground = t.getResourceId(R.styleable.LaybelLayout_text_background, R.drawable.shape_rect_border_primarycolor);
        t.recycle();
    }
    ...
    private void generateDefaultView() {
        for (int i = 0; i < mAdapter.getCount(); ++i) {
            ...
            child.setPadding(dip2px(8),0,dip2px(8),0);
