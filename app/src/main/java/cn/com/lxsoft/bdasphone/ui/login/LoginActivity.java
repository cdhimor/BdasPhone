...
public class LoginActivity extends BaseActivity<ActivityLoginBinding, LoginViewModel> {
    ...
    public void initViewObservable() {
        StatusBarUtils.setBar(this,R.color.white,true);
        ...
        viewModel.uc.pSwitchObservable.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
            ...
            public void onPropertyChanged(Observable observable, int i) {
                ...
                if (viewModel.uc.pSwitchObservable.get()) {
                    ...
                    binding.ivSwichPasswrod.setImageResource(R.drawable.ic_eys);
                    binding.etPassword.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
                } else {
                    //密码不可见
                    binding.ivSwichPasswrod.setImageResource(R.drawable.ic_eysclose);
