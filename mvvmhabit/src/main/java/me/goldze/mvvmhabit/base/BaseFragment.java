...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseActivity {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mBundle != null) {
            viewModel.bundleArguments=mBundle;
        }
    ...
    private void registorUIChangeLiveDataCallBack() {
        ...
        viewModel.getUC().getShowConfirmDialogEvent().observe(this, new Observer<String>() {
            @Override
            public void onChanged(@Nullable String title) {
    ...
    public void showConfirmDialog(String text) {
        ...
        if(confirmdialog==null) {
            confirmdialog = MaterialDialogUtils.showBasicDialogNoCancel(getActivity(), "提示", text)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == 123 && resultCode == RESULT_OK) {
            if(onLoadImageOK!=null)
                onLoadImageOK.onLoad(intent);
        }
    }

    public interface OnLoadImageOK {
        // 回调方法
        void onLoad(Intent intent);
    }
    public OnLoadImageOK onLoadImageOK;
